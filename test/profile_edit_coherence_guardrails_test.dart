...
void main() {
  test('base profile editor covers fields visible on the profile surface', () {
    ...
    expect(profile, contains('_bioSectionTitle(l10n, user)'));
    ...
    expect(arb, contains('"profileBioTitlePlayer": "Présentation du joueur"'));
    expect(profile, contains('_emptyBioMessage(l10n, user)'));
    ...
    expect(profile, contains('subtitle: _profileRoleLabel(l10n, user)'));
