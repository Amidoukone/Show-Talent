...
class _HomeScreenState extends State<HomeScreen> {
  ...
  String? currentVideoUrl; // ✅ Garde l'URL vidéo active
            ...
            return IconButton(
              ...
              onPressed: () {
                if (currentVideoUrl != null) {
                  _videoManager.pause(currentVideoUrl!); // ✅ Pause avant navigation
                }
      ...
      body: Obx(() {
        ...
        return PageView.builder(
          ...
          onPageChanged: (index) {
            ...
            currentVideoUrl = currentVideo.videoUrl; // ✅ Met à jour la vidéo active
